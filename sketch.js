...
var gameOver, gameOverImg, GameOverGroup;
var restart, restartImg, RestartGroup;
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    trex.velocityY = 0;
    cloudsGroup.setLifetimeEach(-0.1);
    obstaclesGroup.setLifetimeEach(-0.1);
    trex.changeAnimation("collided", trex_collided);
    gameOver = createSprite(300, 75, 50,20);
